...
| pacman | ranger                                                    | is an extensive terminal file manager that everyone likes                                           |
...
| pacman | feh                                                       | is a minimal image viewer                                                                           |
...
| pacman | poppler                                                   | manipulates .pdfs and gives .pdf previews in ranger                                                 |
| pacman | mediainfo                                                 | shows audio and video information and is used by ranger as well                                     |
