...
values."
  (setq-default
   ...
   dotspacemacs-additional-packages '(ein julia-mode dumb-jump vala-mode vala-snippets multiple-cursors ace-jump-mode ac-ispell visual-regexp visual-regexp-steroids iedit gnuplot-mode sparql-mode ttl-mode rainbow-mode free-keys glsl-mode haxe-mode xclip calfw calfw-org writeroom-mode selectric-mode pacmacs ox-minutes ox-pandoc arduino-mode org-table-sticky-header orgtbl-ascii-plot treemacs lsp-mode lsp-ui company-lsp lsp-treemacs helm-lsp dap-mode lsp-java solidity-mode flyspell-correct-helm)
   ;;;;  auto-complete-c-headers company-emacs-eclim company-c-headers auto-complete-clang ac-emacs-eclim ac-clang
